...
#####
# This is a custom 'getting started' script, made with care for mscaldas@gmail.com.
...
streamer = Streamer(bucket_name="Python Stream Example", bucket_key="python_example", access_key="NOwR5LCsHTSnZalwI5HA5MQosgztjA8d")
